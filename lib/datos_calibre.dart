...
class DatosCalibrePage extends StatefulWidget {
  final String idMuestra;
  final String cultivo;

  const DatosCalibrePage({super.key, required this.idMuestra, required this.cultivo,});

  @override
  State<DatosCalibrePage> createState() => _DatosCalibrePageState();
}

class _DatosCalibrePageState extends State<DatosCalibrePage> {
  final Map<String, TextEditingController> _controladores = {};
  List<String> _nombresCampos = [];
  bool _cargandoDatos = true;
  bool _guardando = false;
  String _cultivo = ''; // ✅ Nuevo campo para el cultivo
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Datos Calibres'),
        centerTitle: true,
